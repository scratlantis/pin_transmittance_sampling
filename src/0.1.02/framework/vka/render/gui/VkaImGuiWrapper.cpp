...
namespace vka
{
void ImGuiWrapper::vkaImGuiInit(VkRenderPass renderPass, uint32_t subpassIdx)
{
...
void ImGuiWrapper::vkaImGuiRender(VkaCommandBuffer cmdBuf)
{
	ImGui::Render();
	ImGui_ImplVulkan_RenderDrawData(ImGui::GetDrawData(), cmdBuf->getHandle());
}

void ImGuiWrapper::vkaImGuiDestroy()
{
