...
{
	GUI_GROUP_SCENE = 0,
	GUI_GROUP_SETTINGS = 1,
	GUI_GROUP_EVALUATION = 2,
	GUI_GROUP_DEBUG = 0x3,
};
...
enum GuiGroupScene {
	GUI_CAT_SCENE = 0x00000,
	GUI_CAT_MEDIUM = 0x00001,
};
const std::vector<std::string> GuiGroupScene_names = {"Scene", "Medium"};
MASKED_ENUM_ADD_STRING_VALUES(GuiGroupScene, GuiGroupScene_names, GUI_INDEX_MASK)
ENUM_ADD_ITERATOR(GuiGroupScene, GUI_CAT_SCENE, GUI_CAT_MEDIUM)



enum GuiGroupSettings
{
	GUI_CAT_PATH_TRACING = 0x00010,
	GUI_CAT_TONE_MAPPING = 0x00011,
	GUI_CAT_PINS = 0x00012,
	GUI_CAT_RENDER_MODE = 0x00013,
};
...
{
	GUI_CAT_EVALUATION = 0x00020,
	GUI_CAT_METRICS = 0x00021,
};
